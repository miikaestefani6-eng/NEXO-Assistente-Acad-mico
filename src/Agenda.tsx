...
import { generateAdaptivePlan, replanAfterMissedDay } from "./lib/nexo/adaptivePlanner";
...
function Agenda() {
  ...
  const plan = useMemo(() => recoveryMode ? replanAfterMissedDay(getWorkload(), recoveryMinutes, 90, 7) : generateAdaptivePlan(getWorkload(), 90, 7), [recoveryMode, recoveryMinutes, items]);
  ...
  function acceptRecovery() {
    const missed = Math.max(15, pendingMinutes);
