...
import { completeCmsActivity, loadCmsActivities, loadCmsEvents, type CmsActivity, type CmsEvent } from "./lib/nexo/cmsState";
...
function Agenda() {
  ...
  function markDone(id: string) {
    ...
    if (item.cmsId) completeCmsActivity(item.cmsId);
